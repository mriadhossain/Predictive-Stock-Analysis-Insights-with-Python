...
# Fetch historical stock price data for Microsoft
ticker_symbol = 'MSFT'
...
print(f"Predicted MSFT stock price at the end of 2026: ${predicted_price[0]:.2f}")
...
plt.title('MSFT Stock Price Prediction Using Linear Regression')
plt.xlabel('Date')
