...
# Fetch historical stock price data for Alphabet
ticker_symbol = 'GOOGL'
...
print(f"Predicted GOOGL stock price at the end of 2026: ${predicted_price[0]:.2f}")
...
plt.title('GOOGL Stock Price Prediction Using Linear Regression')
plt.xlabel('Date')
